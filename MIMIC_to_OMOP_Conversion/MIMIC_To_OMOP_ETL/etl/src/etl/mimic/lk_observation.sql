...
SELECT src.subject_id          AS subject_id,
       ...
       src.insurance           AS value_as_text,
...
SELECT src.subject_id              AS subject_id,
       ...
       src.admittime               AS start_datetime,
       src.marital_status          AS value_as_text,
...
SELECT src.subject_id                         AS subject_id,
       ...
       src.description                        AS value_as_text,
...
SELECT DISTINCT src.value_as_text      AS source_code,
...
FROM lk_observation_clean src
         LEFT JOIN
     voc_concept vc
     ON src.value_as_text = vc.concept_code
...
FROM lk_observation_clean src
     ...
     ON src.value_as_text = lc.source_code
